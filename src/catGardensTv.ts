...
export const tvChannels: TvChannel[] = [
  ...
  {
    id: 'winona-first-dispatch',
    label: 'MEET WINONA P. GRAY',
    title: 'Meet Winona P. Gray.',
    description: 'Winona P. Gray is a real Cat Gardens resident and the sister of Gray Power. This first YouTube dispatch opens her permanent reality record.',
    schedule: 'NEW YOUTUBE SHORT · CYPRUS',
    youtubeId: cleanYouTubeId('avpx0oLfPmU'),
    poster: '/assets/winona-p-gray-youtube.jpg',
    watchPage: '/Winona',
    kind: 'episode',
  },
  {
    id: 'sanctuary-night-field-note',
    label: 'NIGHT GARDEN · FIELD NOTE',
    title: 'The cat sanctuary at night.',
    description: 'A candid nighttime look at Cat Gardens before the planned privacy-safe camera system is funded and installed. This is an informal field dispatch—not a permanent live feed.',
    schedule: 'NEW YOUTUBE SHORT · PRE-CAMERA FIELD NOTE',
    youtubeId: cleanYouTubeId('QqOMbUFAkVw'),
    poster: '/assets/cat-sanctuary-night-youtube.jpg',
    kind: 'episode',
  },
  {
    id: 'garden-cam',
